...
const (
	...
	Discovery_UpdateWriterServerAddr_FullMethodName    = "/Discovery/UpdateWriterServerAddr"
	Discovery_GetLatestWriterServerAddr_FullMethodName = "/Discovery/GetLatestWriterServerAddr"
)
...
type DiscoveryClient interface {
	...
	UpdateWriterServerAddr(ctx context.Context, in *UpdateWriterServerAddrReq, opts ...grpc.CallOption) (*Status, error)
	GetLatestWriterServerAddr(ctx context.Context, in *GetLatestWriterServerAddrReq, opts ...grpc.CallOption) (*GetAddrReply, error)
}
...
func (c *discoveryClient) UpdateWriterServerAddr(ctx context.Context, in *UpdateWriterServerAddrReq, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, Discovery_UpdateWriterServerAddr_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *discoveryClient) GetLatestWriterServerAddr(ctx context.Context, in *GetLatestWriterServerAddrReq, opts ...grpc.CallOption) (*GetAddrReply, error) {
	out := new(GetAddrReply)
	err := c.cc.Invoke(ctx, Discovery_GetLatestWriterServerAddr_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DiscoveryServer interface {
	...
	UpdateWriterServerAddr(context.Context, *UpdateWriterServerAddrReq) (*Status, error)
	GetLatestWriterServerAddr(context.Context, *GetLatestWriterServerAddrReq) (*GetAddrReply, error)
...
func (UnimplementedDiscoveryServer) UpdateWriterServerAddr(context.Context, *UpdateWriterServerAddrReq) (*Status, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateWriterServerAddr not implemented")
}
func (UnimplementedDiscoveryServer) GetLatestWriterServerAddr(context.Context, *GetLatestWriterServerAddrReq) (*GetAddrReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLatestWriterServerAddr not implemented")
}
...
func _Discovery_UpdateWriterServerAddr_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateWriterServerAddrReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DiscoveryServer).UpdateWriterServerAddr(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Discovery_UpdateWriterServerAddr_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DiscoveryServer).UpdateWriterServerAddr(ctx, req.(*UpdateWriterServerAddrReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Discovery_GetLatestWriterServerAddr_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLatestWriterServerAddrReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DiscoveryServer).GetLatestWriterServerAddr(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Discovery_GetLatestWriterServerAddr_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DiscoveryServer).GetLatestWriterServerAddr(ctx, req.(*GetLatestWriterServerAddrReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Discovery_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateWriterServerAddr",
			Handler:    _Discovery_UpdateWriterServerAddr_Handler,
		},
		{
			MethodName: "GetLatestWriterServerAddr",
			Handler:    _Discovery_GetLatestWriterServerAddr_Handler,
		},
	},
