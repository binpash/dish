...
type UpdateWriterServerAddrReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UpdateWriterServerAddrReq) Reset() {
	*x = UpdateWriterServerAddrReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateWriterServerAddrReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateWriterServerAddrReq) ProtoMessage() {}

func (x *UpdateWriterServerAddrReq) ProtoReflect() protoreflect.Message {
	mi := &file_data_stream_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateWriterServerAddrReq.ProtoReflect.Descriptor instead.
func (*UpdateWriterServerAddrReq) Descriptor() ([]byte, []int) {
	return file_data_stream_proto_rawDescGZIP(), []int{5}
}

func (x *UpdateWriterServerAddrReq) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *UpdateWriterServerAddrReq) GetOldAddr() string {
	if x != nil {
		return x.OldAddr
	}
	return ""
...
func (x *UpdateWriterServerAddrReq) GetNewAddr() string {
	if x != nil {
		return x.NewAddr
	}
	return ""
...
type GetLatestWriterServerAddrReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Id               string `protobuf:"bytes,1,opt,name=Id,proto3" json:"Id,omitempty"`
	WriterServerAddr string `protobuf:"bytes,2,opt,name=WriterServerAddr,proto3" json:"WriterServerAddr,omitempty"`
}

func (x *GetLatestWriterServerAddrReq) Reset() {
	*x = GetLatestWriterServerAddrReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetLatestWriterServerAddrReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLatestWriterServerAddrReq) ProtoMessage() {}

func (x *GetLatestWriterServerAddrReq) ProtoReflect() protoreflect.Message {
	mi := &file_data_stream_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLatestWriterServerAddrReq.ProtoReflect.Descriptor instead.
func (*GetLatestWriterServerAddrReq) Descriptor() ([]byte, []int) {
	return file_data_stream_proto_rawDescGZIP(), []int{6}
}

func (x *GetLatestWriterServerAddrReq) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *GetLatestWriterServerAddrReq) GetWriterServerAddr() string {
	if x != nil {
		return x.WriterServerAddr
	}
	return ""
}
...
var file_data_stream_proto_rawDesc = []byte{
	...
	,
...
var file_data_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_data_stream_proto_goTypes = []interface{}{
	...
	(*Status)(nil),                       // 3: Status
	(*Data)(nil),                         // 4: Data
	(*UpdateWriterServerAddrReq)(nil),    // 5: UpdateWriterServerAddrReq
	(*GetLatestWriterServerAddrReq)(nil), // 6: GetLatestWriterServerAddrReq
}
var file_data_stream_proto_depIdxs = []int32{
	...
	5, // 5: Discovery.UpdateWriterServerAddr:input_type -> UpdateWriterServerAddrReq
	6, // 6: Discovery.GetLatestWriterServerAddr:input_type -> GetLatestWriterServerAddrReq
	...
	3, // 12: Discovery.UpdateWriterServerAddr:output_type -> Status
	2, // 13: Discovery.GetLatestWriterServerAddr:output_type -> GetAddrReply
...
func file_data_stream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_data_stream_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateWriterServerAddrReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_data_stream_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLatestWriterServerAddrReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
