...
func (x *RMessage) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *RMessageReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RMessageReply) ProtoMessage() {}

func (x *RMessageReply) ProtoReflect() protoreflect.Message {
	mi := &file_data_stream_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RMessageReply.ProtoReflect.Descriptor instead.
func (*RMessageReply) Descriptor() ([]byte, []int) {
	return file_data_stream_proto_rawDescGZIP(), []int{6}
}

func (x *RMessageReply) GetUuids() []string {
	if x != nil {
		return x.Uuids
	}
	return nil
...
var file_data_stream_proto_rawDesc = []byte{
	...
	0x49, 0x64, 0x22, 0x34, 0x0a, 0x08, 0x52, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x12,
	0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x61, 0x64,
	0x64, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x05, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x25, 0x0a, 0x0d, 0x52, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x75, 0x75, 0x69,
	0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x75, 0x75, 0x69, 0x64, 0x73, 0x32,
	0xcc, 0x02, 0x0a, 0x09, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x12, 0x21, 0x0a,
	...
	,
...
var file_data_stream_proto_goTypes = []interface{}{
	...
	(*Status)(nil),        // 3: Status
	(*Data)(nil),          // 4: Data
	(*RMessage)(nil),      // 5: RMessage
	(*RMessageReply)(nil), // 6: RMessageReply
}
var file_data_stream_proto_depIdxs = []int32{
	...
	5, // 7: Discovery.RemoveAddrOptimized:input_type -> RMessage
	3, // 8: Discovery.PutAddr:output_type -> Status
	2, // 9: Discovery.GetAddr:output_type -> GetAddrReply
	3, // 10: Discovery.RemoveAddr:output_type -> Status
	4, // 11: Discovery.readStream:output_type -> Data
	3, // 12: Discovery.writeStream:output_type -> Status
	3, // 13: Discovery.PutAddrOptimized:output_type -> Status
	2, // 14: Discovery.GetAddrOptimized:output_type -> GetAddrReply
	6, // 15: Discovery.RemoveAddrOptimized:output_type -> RMessageReply
