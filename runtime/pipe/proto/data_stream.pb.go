...
func (x *FPMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FPMessage) ProtoMessage() {}

func (x *FPMessage) ProtoReflect() protoreflect.Message {
	mi := &file_data_stream_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FPMessage.ProtoReflect.Descriptor instead.
func (*FPMessage) Descriptor() ([]byte, []int) {
	return file_data_stream_proto_rawDescGZIP(), []int{5}
}

func (x *FPMessage) GetUuids() []string {
	if x != nil {
		return x.Uuids
	}
	return nil
...
func (x *FPMessage) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *FPMessageReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FPMessageReply) ProtoMessage() {}

func (x *FPMessageReply) ProtoReflect() protoreflect.Message {
	mi := &file_data_stream_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FPMessageReply.ProtoReflect.Descriptor instead.
func (*FPMessageReply) Descriptor() ([]byte, []int) {
	return file_data_stream_proto_rawDescGZIP(), []int{6}
}

func (x *FPMessageReply) GetIndexes() []int32 {
	if x != nil {
		return x.Indexes
	}
	return nil
...
func (x *RPMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RPMessage) ProtoMessage() {}

func (x *RPMessage) ProtoReflect() protoreflect.Message {
	mi := &file_data_stream_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RPMessage.ProtoReflect.Descriptor instead.
func (*RPMessage) Descriptor() ([]byte, []int) {
	return file_data_stream_proto_rawDescGZIP(), []int{7}
}

func (x *RPMessage) GetUuids() []string {
	if x != nil {
		return x.Uuids
	}
	return nil
...
var file_data_stream_proto_rawDesc = []byte{
	...
	,
...
var file_data_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_data_stream_proto_goTypes = []interface{}{
	...
	(*Status)(nil),         // 3: Status
	(*Data)(nil),           // 4: Data
	(*FPMessage)(nil),      // 5: FPMessage
	(*FPMessageReply)(nil), // 6: FPMessageReply
	(*RPMessage)(nil),      // 7: RPMessage
}
var file_data_stream_proto_depIdxs = []int32{
	...
	5, // 7: Discovery.FindPersistedOptimized:input_type -> FPMessage
	7, // 8: Discovery.RemovePersistedOptimized:input_type -> RPMessage
	3, // 9: Discovery.PutAddr:output_type -> Status
	2, // 10: Discovery.GetAddr:output_type -> GetAddrReply
	3, // 11: Discovery.RemoveAddr:output_type -> Status
	4, // 12: Discovery.readStream:output_type -> Data
	3, // 13: Discovery.writeStream:output_type -> Status
	3, // 14: Discovery.PutAddrOptimized:output_type -> Status
	2, // 15: Discovery.GetAddrOptimized:output_type -> GetAddrReply
	6, // 16: Discovery.FindPersistedOptimized:output_type -> FPMessageReply
	3, // 17: Discovery.RemovePersistedOptimized:output_type -> Status
...
func file_data_stream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_data_stream_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RPMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
